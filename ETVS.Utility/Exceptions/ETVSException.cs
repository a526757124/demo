...
namespace ETVS.Utility.Exceptions
{
    /// <summary>
    /// OSharp框架异常类
    /// </summary>
    [Serializable]
    public class ETVSException : Exception
    {
        /// <summary>
        /// 初始化<see cref="OSharpException"/>类的新实例
        /// </summary>
        public ETVSException()
        { }
        ...
        public ETVSException(string message)
            : base(message)
        { }
        ...
        public ETVSException(string message, Exception inner)
            : base(message, inner)
        { }
        ...
        protected ETVSException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        { }
    }
}